...
if __name__ == "__main__":
    ...
    receiveragent = ReceiverAgent("andre@jix.im", "RelouSI")

    # sender_jid = input("Sender JID> ")
    # passwd = getpass.getpass()
    senderagent = PeriodicSenderAgent("maluf@jix.im", "RelouSI")

    future = receiveragent.start(auto_register=True)
    future.result()  # wait for receiver agent to be prepared.

    senderagent.set("receiver_jid", "andre@jix.im")  # store receiver_jid in the sender knowledge base
